...
See "Getting started with amqp gem":#Getting_started_with_amqp_gem and "Documentation: tutorials, guides & API reference":#Documentation_tutorials_guides_API_reference
