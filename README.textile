...
amqp gem is a widely used, feature-rich asynchronous AMQP 0.9.1 client with batteries included.
...
See "Getting started with amqp gem":#Getting_started_with_amqp_gem and "Documentation: tutorials, guides & API reference":#Documentation__tutorials__guides___API_reference
