...
"Tutorials":https://github.com/ruby-amqp/rabbitmq-tutorials aren't written yet :( Please refer to Examples
and Documentation. Every major class and class method in documentation has usage examples as well as brief introduction to AMQP
...
Documentation is "up on rdoc.info":http://rdoc.info/github/ruby-amqp/amqp/master/frames and is updated daily. It describes
both the library itself and AMQP usage scenarios, broker-specific extensions, topics like dealing with ancient RabbitMQ versions
Debian and Ubuntu ship with and so on.
...
* "API Documentation":http://rdoc.info/github/ruby-amqp/amqp/master/frames
