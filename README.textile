...
<pre>gem install amqp --pre # installs 0.8.0.RCs</pre>
...
"Getting started guide":http://rdoc.info/github/ruby-amqp/amqp/master/file/docs/GettingStarted.textile is written as a tutorial that walks you through
...
"API reference":http://rdoc.info/github/ruby-amqp/amqp/master/frames is up on rdoc.info and is updated daily.
