...
AMQP 0.9.1 is a programmable protocol in a sense that routing schemes are defined by applications themselves, not a broker administrator. So there are protocol
