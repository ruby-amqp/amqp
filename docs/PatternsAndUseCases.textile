...
The Event pattern is very similar to the Command pattern with the difference that event listeners are often "passive" (do not respond
to events or perform actions other than updating counters, persisting event information and so on).
