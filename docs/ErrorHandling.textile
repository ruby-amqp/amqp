...
<dl>
  ...
  <dd>PRECONDITION_FAILED - parameters for queue 'amqpgem.examples.channel_exception' in vhost '/' not equivalent</dd>
</dl>
...
<dl>
  ...
  Alternatively, multiple consumer across multiple or single app might be registered as exclusive for the same queue.
  </dd>
