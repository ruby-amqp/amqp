...
Each application choose how to handle graceful broker shutdowns individually, so *amqp gem's automatic recovery mode does not cover graceful broker shutdowns*.
