...
{include:file:examples/guides/queues/01a_declaring_a_server_named_queue_using_queue_constructor.rb}

If you want to declare a queue with a particular name, for example, "images.resize", pass it to Queue class constructor:

{include:file:examples/guides/queues/01b_declaring_a_queue_using_queue_constructor.rb}
...
{include:file:examples/guides/queues/02a_declaring_a_durable_shared_queue.rb}

the same piece of code that uses {AMQP::Channel#queue} for convenience:

{include:file:examples/guides/queues/02b_declaring_a_durable_shared_queue.rb}
...
{include:file:examples/guides/queues/03a_declaring_a_temporary_exclusive_queue.rb}

the same piece of code that uses {AMQP::Channel#queue} for convenience:

{include:file:examples/guides/queues/03b_declaring_a_temporary_exclusive_queue.rb}
...
{include:file:examples/guides/queues/04_bind_a_queue_using_exchange_instance.rb}

or an exchange name given as a string:

{include:file:examples/guides/queues/05_bind_a_queue_using_exchange_name.rb}
...
{include:file:examples/guides/queues/06_subscribe_to_receive_messages.rb}


In books, articles and documentation about AMQP 0.9.1 you may come around discussions of <i>consumer tags</i>. Consumer tag in AMQP
parlance is identifier for subscription: most often, it is used to unsubscribe from messages (more on that later in this chapter).
...
{include:file:examples/guides/queues/07_fetch_a_message_from_the_queue.rb}
...
{include:file:examples/guides/queues/08_unsubscribing_a_consumer.rb}
...
{include:file:examples/guides/queues/09_unbinding_from_exchange.rb}
...
{include:file:examples/guides/queues/10_purge_a_queue.rb}
...
{include:file:examples/guides/queues/11_deleting_a_queue.rb}
